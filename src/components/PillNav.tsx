...
interface PillNavProps {
  ...
  mobileExtraControls?: React.ReactNode;
}
  ...
  return (
    <div className="pill-nav-container">
      <nav className={`pill-nav pill-nav--liquid-glass ${className}`} aria-label="Primary" style={cssVars}>
        ...
        {extraControls && (
          <div className="pill-nav-controls desktop-only" style={cssVars}>
            {extraControls}
          </div>
        )}
      ...
      <div className="mobile-menu-popover mobile-only" ref={mobileMenuRef}>
        ...
        {mobileExtraControls && (
          <div className="mobile-menu-controls">{mobileExtraControls}</div>
        )}
      </div>
    </div>
  );
