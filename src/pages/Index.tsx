...
const stats = [
  ...
  { value: "120+", label: "Projects Delivered", icon: Award },
  { value: "40+", label: "Happy Clients", icon: Users },
  { value: "6", label: "Creative Fields", icon: Layers },
];
  ...
  return (
    <div className="min-h-screen overflow-x-hidden dot-grid" style={{ background: "var(--gradient-bg)" }}>
      ...
      >
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative z-10 w-full">
          <div className="max-w-7xl mx-auto px-6 pt-28 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              >
                <span className="section-label">Graphic Designer · 3D Artist · Visual Experiences</span>
              </motion.div>
              ...
              >
                Creating immersive visual experiences at the intersection of design, art, branding, and digital interaction. Where concept becomes sensation.
              </motion.p>
            ...
            <div className="relative flex items-center justify-center min-h-[500px]">
              ...
              {floatingBadges.map((badge, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="font-display text-xs tracking-[0.1em] uppercase" style={{ color: "hsl(var(--foreground))" }}>
                      {badge.label}
                    </span>
                  </motion.div>
                </motion.div>
              ...
              <motion.div
                ...
                style={{
                  filter: "drop-shadow(0 0 60px rgba(112,251,249,0.25)) drop-shadow(0 0 120px rgba(231,57,245,0.15))",
                }}
              >
                <motion.img
                  src={heroVisual}
                  alt="Liquid Glass Crystal"
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle at ${mousePos.x * 100}% ${mousePos.y * 100}%, rgba(112,251,249,0.12) 0%, transparent 60%)`,
                    filter: "blur(20px)",
        ...
        >
          <span className="font-display text-xs tracking-[0.25em] uppercase" style={{ color: "hsl(var(--muted-foreground))" }}>
            Scroll
          </span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
      ...
      <FadeInSection>
        <section className="relative py-12">
          <div className="max-w-7xl mx-auto px-6">
            <div
              className="glass-panel p-1 rounded-2xl"
              style={{ boxShadow: "var(--glow-combined)" }}
            >
      ...
      <section className="relative py-32 overflow-hidden">
        {/* Wide glass shard behind text */}
        <div
          className="absolute left-0 right-0"
          style={{
            top: "50%",
            height: "120px",
            background: "rgba(112,251,249,0.025)",
            backdropFilter: "blur(8px)",
            borderTop: "1px solid rgba(112,251,249,0.08)",
            borderBottom: "1px solid rgba(112,251,249,0.08)",
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <FadeInSection>
            <span className="section-label mb-8 block">Philosophy</span>
          </FadeInSection>
            ...
            >
              ...
              <span className="relative">
                ...
                <span
                  ...
                  style={{
                    background: "rgba(112,251,249,0.05)",
                    backdropFilter: "blur(4px)",
                    border: "1px solid rgba(112,251,249,0.1)",
                  }}
                />
              </span>
            </h2>
          ...
          <FadeInSection delay={0.6} className="mt-10 max-w-lg">
            <p className="font-body text-lg leading-relaxed" style={{ color: "hsl(var(--muted-foreground))" }}>
              An experience that blurs the line between digital and physical — where every pixel carries intention, every transition carries meaning.
            </p>
          </FadeInSection>
        </div>
      </section>
                ...
                <div className="glass-panel group overflow-hidden h-[420px] relative" style={{ cursor: "none" }}>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-2 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                      <span className="font-display text-xs tracking-widest uppercase" style={{ color: "hsl(var(--primary))" }}>View Project</span>
                    ...
                    <div className="glass-panel group overflow-hidden h-[196px] relative" style={{ cursor: "none" }}>
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-5 space-y-1">
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          <span className="font-display text-xs tracking-widest uppercase" style={{ color: "hsl(var(--primary))" }}>View</span>
          ...
          <div className="glass-panel p-12 md:p-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center" style={{ boxShadow: "var(--glow-combined)" }}>
            <FadeInSection>
              <div className="relative">
                <div
                  ...
                  style={{
                    background: "radial-gradient(circle at 40% 40%, rgba(112,251,249,0.15) 0%, rgba(231,57,245,0.1) 60%, transparent 80%)",
                    filter: "blur(24px)",
                  }}
                />
                <img
            ...
            <FadeInSection delay={0.2} className="space-y-6">
              ...
              <h2 className="font-display font-bold uppercase" style={{ fontSize: "clamp(1.8rem, 3.5vw, 3rem)" }}>
                CRAFTING THE IMPOSSIBLE INTO VISUAL REALITY
              </h2>
              <p className="font-body leading-relaxed" style={{ color: "hsl(var(--muted-foreground))" }}>
                I'm a multidisciplinary graphic designer and visual artist with over 7 years of experience crafting brands, identities, and digital experiences that push the boundaries of conventional design.
              </p>
              <div className="grid grid-cols-2 gap-3">
                {["Blender", "Adobe CC", "Cinema 4D", "Figma", "After Effects", "Substance 3D"].map((tool) => (
                  <div key={tool} className="glass-panel-sm px-3 py-2 text-center">
                    <span className="font-display text-xs tracking-[0.15em] uppercase" style={{ color: "hsl(var(--primary))" }}>
                      {tool}
                    </span>
                  </div>
                ))}
              ...
              <Link to="/about">
                <button className="btn-glass-primary mt-4">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <FadeInSection>
            <span className="section-label justify-center mb-6 flex">Contact</span>
            <h2
            ...
            <p className="font-body text-lg mb-10 mx-auto max-w-md" style={{ color: "hsl(var(--muted-foreground))" }}>
              Ready to bring your vision to life? I'm available for select projects and collaborations.
            </p>
            <Link to="/contact">
              <button
                className="btn-glass-primary px-10 py-4 text-base"
