...
const services = ["Brand Identity", "Motion Design", "3D & Visualization", "UI/UX Design", "Packaging Design", "Creative Direction"];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeInSection>
            ...
            <p className="font-body text-xl max-w-lg" style={{ color: "hsl(var(--muted-foreground))" }}>
              Have a project in mind? Ready to build something remarkable together? I'd love to hear from you.
            </p>
          </FadeInSection>
        </div>
      </div>
          ...
          <FadeInSection delay={0.1} className="lg:col-span-2 space-y-6">
            ...
            <div className="glass-panel p-6 space-y-4" style={{ boxShadow: "var(--glow-cyan-sm)" }}>
              ...
              <p className="font-body text-sm leading-relaxed" style={{ color: "hsl(var(--muted-foreground))" }}>
                Currently accepting select projects for Q1–Q2 2025. Response time is typically within 24 hours.
              </p>
              ...
              <div className="flex items-center gap-2 text-xs font-display tracking-[0.1em] uppercase" style={{ color: "hsl(var(--muted-foreground))" }}>
                ...
                New York, USA · Remote Worldwide
              </div>
              <div className="flex items-center gap-2 text-xs font-display tracking-[0.1em] uppercase" style={{ color: "hsl(var(--muted-foreground))" }}>
                <Mail className="w-3 h-3" />
                hello@refractionpoint.com
              </div>
            </div>
            ...
            <div className="glass-panel p-6 space-y-4">
              ...
              <div className="space-y-2">
                {services.map((svc) => (
                  <div
                    key={svc}
                    className="font-display text-xs tracking-[0.1em] uppercase px-3 py-2 rounded-xl transition-all duration-200"
                    style={{
                      background: "rgba(112,251,249,0.04)",
              ...
              {status === "sent" ? (
                ...
                >
                  <div
                    ...
                    style={{
                      background: "rgba(112,251,249,0.1)",
                      border: "1px solid rgba(112,251,249,0.4)",
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <span className="section-label block mb-8">Send a Message</span>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <option value="" style={{ background: "hsl(var(--background))" }}>Select a service...</option>
                      {services.map((s) => (
                  ...
                  <button
                    ...
                    className="btn-glass-primary w-full justify-center py-4 text-sm"
                    style={{
