...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.card.name": "Alex Fontaine",
    "about.card.title": "Creative Director",
    "about.card.handle": "alexfontaine",
  ...
  pt: {
    ...
    "index.cta.line1": "VAMOS CRIAR",
    "index.cta.line2": "ALGO",
    ...
    "about.card.name": "Alex Fontaine",
    "about.card.title": "Diretor Criativo",
    "about.card.handle": "alexfontaine",
