...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "index.hero.h1a": "IF YOU CAN",
    "index.hero.h1b": "IMAGINE IT,",
    "index.hero.h1c": "YOU CAN DO IT.",
    ...
    "contact.available.body": "Currently accepting projects for 2026. Response time is typically within 24 hours.",
    "contact.response": "Response within 24h",
    "contact.location": "São Paulo, Brazil — Remote worldwide",
  ...
  pt: {
    ...
    "index.hero.h1a": "SE DÁ PARA",
    "index.hero.h1b": "IMAGINAR,",
    "index.hero.h1c": "DÁ PARA FAZER.",
    "index.hero.description": "",
    ...
    "about.story.p2": "Nascido e criado na cidade de Uberlândia-MG, aos 18 anos decidi começar a atuar com o design gráfico de fato, sendo aquilo que eu mais gostava, me mudando para São Paulo - SP, tendo a expectativa de me especializar no assunto.",
    ...
    "contact.available.body": "Aceitando projetos para 2026. Tempo de resposta geralmente dentro de 24 horas.",
    "contact.response": "Resposta em até 24h",
    "contact.location": "São Paulo, Brasil — Remoto em todo o mundo",
